        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              <label
                htmlFor="name"
                className="flex gap-2 items-center text-sm font-medium text-slate-300"
              >
                Full Name
                {validName && formData.name ? (
                  <Check className="text-green-600 w-4 h-4 transition-all duration-200" />
                ) : (
                  focusName && (
                    <X className="text-red-600 w-4 h-4 transition-all duration-200" />
                  )
                )}
              </label>
              <input
              ...
              />
              {focusName && formData.name && !validName && (
                <FormInstructions>
                  Full Name must contains min 2 characters and max 24
                  characters.
                </FormInstructions>
              )}
            </div>
            <div>
              ...
              <input
                ...
                onChange={handleChange}
              />
              {focusEmail && formData.email && !validEmail && (
                <FormInstructions>
            ...
            <div>
              ...
              >
                Confirm Password
                {validMatch && formData.confirmPassword ? (
                  <Check className="text-green-600 w-4 h-4 transition-all duration-200" />
                ) : (
                  focusMatch && (
                    <X className="text-red-600 w-4 h-4 transition-all duration-200" />
              ...
              {!validMatch && formData.password && formData.confirmPassword && (
                <FormInstructions>Must match the password.</FormInstructions>
              )}
            </div>
          </div>
